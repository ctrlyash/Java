...
// Enter marks: 90.456799
// You entered: 90.4568
// This is a floating point error (Values are not accurate in float)
...
// nextFloat() is a method of the class Scanner that is used to take input as a float from the user
